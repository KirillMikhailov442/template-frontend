  ...
  return (
    <>
      <div
        ...
        className="min-w-[200px] max-w-[300px] rounded-2xl overflow-hidden flex flex-col shadow-md relative group">
          ...
          <Menu.Root>
            <Menu.Trigger>
              <IconButton
                rounded="xl"
                size="xs"
                className="opacity-50 md:opacity-0 group-hover:opacity-50">
                <LucideMoreVertical />
              </IconButton>
            </Menu.Trigger>
            <Portal>
